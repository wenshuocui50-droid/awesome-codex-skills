...
- [repo-cartographer](https://github.com/wenshuocui50-droid/repo-cartographer) - Maps an unfamiliar codebase into docs/architecture.md: Mermaid system map, module dependency graph, a file-verified core flow, and a 5-file reading order. Trigger: "map this repo", "how is this organized", "where do I start reading". Install: copy SKILL.md into `~/.codex/skills/repo-cartographer/`.
